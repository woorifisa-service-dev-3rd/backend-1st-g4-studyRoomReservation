...
public class OutputView {
	...
	public void writeGameStats(String userName, double successRate, double correctAnswerRate) {

		StringBuilder write = new StringBuilder();

		write.append(userName).append("님의 게임 기록입니다.").append("\n");
	...
	public void writeWelcomeLoginUser(String userName) {
		System.out.printf(Message.LOGIN_MESSAGE, userName);

	}

	public void writeWelcomeSignupUser(String userName) {
